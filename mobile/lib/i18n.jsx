...
const T = {
  ja: {
    ...
    registerSub: "チームに参加する",
    firstName: "名",
    lastName: "姓",
    email: "メールアドレス",
    confirmPassword: "パスワード確認",
    position: "役職",
    clinicStaff: "クリニックスタッフ",
    officeStaff: "オフィススタッフ",
    clinicNameLabel: "クリニック名",
    officeNameLabel: "オフィス名",
    clinicNamePlaceholder: "クリニック名を入力",
    officeNamePlaceholder: "オフィス名を入力",
    sendCode: "確認コードを送信",
    sendingCode: "送信中…",
    verifyEmail: "メール認証",
    codeSentTo: "コードを送信しました",
    verifyCreate: "認証してアカウントを作成",
    verifying: "認証中…",
    resendCode: "コードを再送",
    ...
    invalidOTP: "無効なコード",
    enterSixDigit: "メールに送信された6桁のコードを入力してください",
    invalidOrExpired: "無効または期限切れのコードです",
    selectPosition: "役職を選択してください",

    // Auth — Forgot Password
    forgotPasswordTitle: "パスワードを忘れた",
    forgotPasswordSub: "リセットコードをメールでお送りします",
    sendResetCode: "リセットコードを送信",
    sending: "送信中…",
    checkEmail: "メールを確認してください",
    newPasswordTitle: "新しいパスワード",
    newPasswordSub: "強力なパスワードを設定してください",
    resetPassword: "パスワードをリセット",
    updating: "更新中…",
    continueBtn: "続ける",
    passwordUpdated: "パスワードを更新しました",
    passwordUpdatedMsg: "新しいパスワードでサインインできます",
    ...
    editItemTitle: "アイテムを編集",
    itemUpdated: "アイテムが更新されました。",
    editBatchesTitle: "バッチを編集",
    saveBatch: "バッチを保存",
    batchUpdated: "バッチが更新されました。",
    changeImage: "画像を変更",
    removeImage: "削除",
    saveChanges: "変更を保存",
  ...
  en: {
    ...
    registerSub: "Join your clinic team",
    ...
    clinicNamePlaceholder: "Your clinic name",
    officeNamePlaceholder: "Your office name",
    ...
    passwordUpdatedMsg: "You can now sign in with your new password",
